...
public struct SteamId
{
	...
	public static explicit operator int(SteamId id)
		=> Unsafe.ReadUnaligned<int>(ref MemoryMarshal.GetReference<byte>(id));

	public static explicit operator uint(SteamId id)
		=> Unsafe.ReadUnaligned<uint>(ref MemoryMarshal.GetReference<byte>(id));
